...
export class CreateEmployee1770438756319 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // 1. Create Types for Enums
        await queryRunner.query(`CREATE TYPE "public"."employee_profiles_employment_type_enum" AS ENUM('FULL_TIME', 'INTERN', 'CONTRACT')`);
        await queryRunner.query(`CREATE TYPE "public"."employee_profiles_employment_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'ON_NOTICE', 'EXITED')`);

        // 2. Create Table with snake_case columns to match Entity JoinColumns
