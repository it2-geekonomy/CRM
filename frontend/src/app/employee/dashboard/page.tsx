      ...
      <div className="max-w-[1400px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <div className="space-y-4">
              {[
                { title: "New Design", desc: "Start a design task", icon: "🎨" },
                { title: "Upload Assets", desc: "Add files to project", icon: "📤" },
                { title: "Submit Review", desc: "Send to client", icon: "✅" },
                { title: "Log Time", desc: "Track hours", icon: "⏱️" },
                { title: "Request Feedback", desc: "Get team input", icon: "💬" },
                {
                  title: "My Projects",
                  desc: "View all work",
                  icon: "📊",
                  onClick: () => router.push("/employee/dashboard/projects"),
                },
              ].map((item) => (
                <div
                  key={item.title}
                  ...
                  onKeyDown={(e) => {
                    if ("onClick" in item && (e.key === "Enter" || e.key === " ")) {
