  ...
  if (isError || !project) {
    return (
      <div className="bg-gray-100 min-h-screen py-10 flex items-center justify-center">
        ...
        <Link href="/employee/dashboard/projects" className="mt-4 text-green-600 hover:underline block">
          ← Back to Projects
        </Link>
      </div>
    );
        ...
        <div className="max-w-[1600px] mx-auto px-8">
          ...
          <div className="text-sm">
            ...
            <button
              type="button"
              onClick={() => {
                // Navigate to dashboard with Projects filter active
                if (typeof window !== "undefined") {
                  sessionStorage.setItem("dashboardFilter", "Projects");
                }
